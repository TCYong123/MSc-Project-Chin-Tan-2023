...
plt.figure()
plt.semilogy(n0, im_energy1, label="IM, ref=1")
...
plt.figure()
plt.semilogy(n0, imR_energy1, label="IM(R), ref=1")
...
plt.figure()
plt.semilogy(n0, imE_energy1, label="IM(E), ref=1")
...
plt.figure()
plt.semilogy(n0, tr_energy1, label="TR-BDF2, ref=1")
...
plt.figure()
plt.semilogy(n0, trR_energy1, label="TR-BDF2(R), ref=1")
...
plt.figure()
plt.semilogy(n0, trE_energy1, label="TR-BDF2(E), ref=1")
